...
public class TestPlotSoftPatterns
{
	...
	private static void setupDrivers(Context context) {
		...
		IPlotter plotterAdapter = new LinePlotterAdapter();
		context.addDriver("Ploter Adapter", plotterAdapter);
		...
		Application.getComponent(DriverManager.class).setCurrentPlotter(plotterAdapter);
