...
public class ApplicationWithDrawer {
	...
	private static void setupDrawerPlugin(Context context) {    
		...
		Application.addComponent(DrawAdapter.class);
		context.addComponentMenu(DrawAdapter.class, "Draw Panel", 0);
		context.addComponentMenuElement(DrawAdapter.class, "Clear Panel", selectClearPanelOptionListener);
	...
	public static DrawPanelController getDrawPanelController() {
		return Application.getComponent(DrawAdapter.class);
	}
