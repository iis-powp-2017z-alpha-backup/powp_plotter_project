...
public class ApplicationWithDrawer {
	...
	private static void setupDrawerPlugin(Context context) {    
		...
		Application.addComponent(Adapter.class);
		context.addComponentMenu(Adapter.class, "Draw Panel", 0);
		context.addComponentMenuElement(Adapter.class, "Clear Panel", selectClearPanelOptionListener);
	...
	public static DrawPanelController getDrawPanelController() {
		return Application.getComponent(Adapter.class);
	}
